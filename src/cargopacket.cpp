 ...
 */
uint StationCargoList::Reroute(uint max_move, StationCargoList *dest, StationID avoid, const GoodsEntry *ge)
{
	return this->ShiftCargo(CargoReroute(this, dest, max_move, avoid, ge), avoid, false);
}
