...
static const SaveLoad _flow_desc[] = {
	SLE_CONDVAR(FlowSaveLoad, source, SLE_UINT16, SL_FLOWS, SL_MAX_VERSION),
	SLE_CONDVAR(FlowSaveLoad, via,    SLE_UINT16, SL_FLOWS, SL_MAX_VERSION),
	SLE_CONDVAR(FlowSaveLoad, share,  SLE_UINT32, SL_FLOWS, SL_MAX_VERSION),
	SLE_END()
};
...
const SaveLoad *GetGoodsDesc()
{
	static const SaveLoad goods_desc[] = {
		...
		SLEG_CONDVAR(            _num_dests,          SLE_UINT32,        SL_CARGOMAP, SL_MAX_VERSION),
		 ...
		 SLE_CONDVAR(GoodsEntry, link_graph,          SLE_UINT16,           SL_FLOWS, SL_MAX_VERSION),
		 SLE_CONDVAR(GoodsEntry, node,                SLE_UINT16,           SL_FLOWS, SL_MAX_VERSION),
		SLEG_CONDVAR(            _num_flows,          SLE_UINT32,           SL_FLOWS, SL_MAX_VERSION),
		SLE_END()
	};
