...
bool AfterLoadGame()
{
	...
	if (CheckSavegameVersion(44)) {
		...
		/* Oh come on! This only holds for savegames before version 44 and only for cargo that's currently en-route.
		 * I don't think this deserves code to fix it. Just let them get a that extra profit in this case.
		 */
