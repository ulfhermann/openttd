...
const SettingDesc _settings[] = {
 ...
 SDT_CONDOMANY(GameSettings, vehicle.road_side,                    SLE_UINT8, 97, SL_MAX_VERSION, 0,NN, 1,   1, "left|right", STR_NULL, CheckRoadSide, NULL),
	...
	SDT_CONDVAR(GameSettings, economy.moving_average_length,	SLE_UINT16,CAPACITIES_SV, SL_MAX_VERSION, 0, 0,256,	1,	4096,	128,	STR_CONFIG_SETTING_AVERAGE_LENGTH, 		   NULL),
